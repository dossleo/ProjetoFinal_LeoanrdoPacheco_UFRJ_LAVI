...
class GeneralFuncions():
    ...
    def tempo_decorrido(self, start, ciclo_atual, ciclos_totais):
...
class GerarCSV(GeneralFuncions):
    ...
    def run(self):
        ciclos_totais = self.calcula_ciclos_totais()
        ciclo_atual = 0
        ...
        for ordem in ordens:
            ...
            for pasta in self.PASTAS:
                ...
                for arquivo in arquivos:
                    ...
                    ciclo_atual += 1
                    self.tempo_decorrido(start=start, ciclo_atual=ciclo_atual, ciclos_totais = ciclos_totais)
